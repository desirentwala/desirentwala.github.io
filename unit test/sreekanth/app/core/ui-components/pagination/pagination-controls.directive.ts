...
import {Subscription}                                              from '@adapters/packageAdapter';
...
export class PaginationControlsDirective {
    ...
    totalItems;
        ...
        getCurrent(): number {
        let current = this.service.getCurrentPage(this.id);
        let inst = this.service.getInstance(this.id);
        this.totalItems = inst.totalItems;
        this.fromItem = (current-1) * inst.itemsPerPage;
        this.fromItem = (this.fromItem > 1 ) ? this.fromItem + 1 : 1;
        this.fromItem = (this.totalItems == 0) ? 0:this.fromItem; 
        this.toItem = current * inst.itemsPerPage;
