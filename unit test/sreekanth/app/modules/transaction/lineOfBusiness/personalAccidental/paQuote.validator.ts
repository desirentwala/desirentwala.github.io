...
export class PersonalAccidentQuoteValidator {
    ...
    setPAQuotValidatorBasicDetails(pAQuotForm: FormGroup, productCode?: string): FormGroup {
        ...
        if (productCode === 'PAI') {
            ...
            riskInfoArray.at(0).get('appFName').setValidators(Validators.compose([Validators.required, Validators.pattern('([a-zA-Z\'?]{1,30}\s*)+')]));
            ...
            riskInfoArray.at(0).get('itemPlanSelectedCode').setValidators(Validators.compose([Validators.required]));
            riskInfoArray.at(0).get('itemPlanSelectedDesc').setValidators(Validators.compose([Validators.required]));
            riskInfoArray.at(0).get('itemPlanSelectedCode').updateValueAndValidity();
            riskInfoArray.at(0).get('itemPlanSelectedDesc').updateValueAndValidity();
        }
    ...
    setReferQuoteModalValidator(_referQuoteModalForm) {
        this.paQuoteFormGroup = _referQuoteModalForm;
        this.paQuoteFormGroup.controls['referQuotInfo'].get('referTo').setValidators(Validators.compose([EmailIdvalidators.multiplemailFormat(','), Validators.required]));
        this.paQuoteFormGroup.controls['referQuotInfo'].get('referTo').updateValueAndValidity();
        this.paQuoteFormGroup.controls['referQuotInfo'].get('ccAddress').setValidators(Validators.compose([EmailIdvalidators.multiplemailFormat(',')]));
        this.paQuoteFormGroup.controls['referQuotInfo'].get('ccAddress').updateValueAndValidity();
        this.paQuoteFormGroup.controls['referQuotInfo'].get('referralRemarks').setValidators(Validators.compose([Validators.required]));
        this.paQuoteFormGroup.controls['referQuotInfo'].get('referralRemarks').updateValueAndValidity();
        return this.paQuoteFormGroup;
    }
    setPAQuotCustomerInfoValidator(pAQuotForm): FormGroup {
        this.paQuoteFormGroup = pAQuotForm;
        this.paQuoteFormGroup.controls['customerInfo'].get('appFName').setValidators(Validators.compose([Validators.required, Validators.pattern('([a-zA-Z\'?]{1,30}\s*)+')]));
        this.paQuoteFormGroup.controls['customerInfo'].get('appFName').updateValueAndValidity();
        this.paQuoteFormGroup.controls['customerInfo'].get('appMName').setValidators(Validators.compose([Validators.pattern('([a-zA-Z\'?]{1,30}\s*)+')]));
        this.paQuoteFormGroup.controls['customerInfo'].get('appMName').updateValueAndValidity();
        this.paQuoteFormGroup.controls['customerInfo'].get('appLName').setValidators(Validators.compose([Validators.required, Validators.pattern('([a-zA-Z\'?]{1,30}\s*)+')]));
    ...
    clearPAQuotCustomerInfoValidator(insuredFormGroup: FormGroup) {
        ...
        this.paQuoteFormGroup.controls['customerInfo'].get('appFName').updateValueAndValidity();
        this.paQuoteFormGroup.controls['customerInfo'].get('appMName').setValidators(null);
        this.paQuoteFormGroup.controls['customerInfo'].get('appMName').updateValueAndValidity();
    ...
    setPAQuotInsuredValidators(insuredFormGroup: FormGroup): FormGroup {
        insuredFormGroup.get('appFName').setValidators(Validators.compose([Validators.required, Validators.pattern('([a-zA-Z\'?]{1,30}\s*)+')]));
        insuredFormGroup.get('appFName').updateValueAndValidity();
        insuredFormGroup.get('appLName').setValidators(Validators.compose([Validators.required, Validators.pattern('([a-zA-Z\'?]{1,30}\s*)+')]));
        ...
        insuredFormGroup.get('mobilePh').setValidators(Validators.compose([Validators.required, MinSizeValidator.minSize(9),MaxSizeValidator.maxSize(14)]));
    ...
    setPAQuotNomineeValidators(nomineeFormGroup: any) {
        nomineeFormGroup.get('appFName').setValidators([Validators.required, Validators.pattern('([a-zA-Z\'?]{1,30}\s*)+')]);
        nomineeFormGroup.get('appFName').updateValueAndValidity();
        nomineeFormGroup.get('appLName').setValidators([Validators.required, Validators.pattern('([a-zA-Z\'?]{1,30}\s*)+')]);
    ...
    setPAIRiskValidator(riskGroup, doNomineeValidation: boolean = true, multiItemFlag: boolean = false) {
        ...
        riskGroup.get('appFName').setValidators(Validators.compose([Validators.required, Validators.pattern('([a-zA-Z\'?]{1,30}\s*)+')]));
        ...
        riskGroup.get('relationshipToInsuredCode').setValidators(Validators.compose([Validators.required]));
        riskGroup.get('relationshipToInsuredCode').updateValueAndValidity();
        riskGroup.get('relationshipToInsuredDesc').setValidators(Validators.compose([Validators.required]));
        riskGroup.get('relationshipToInsuredDesc').updateValueAndValidity();
        ...
        if (multiItemFlag) {
            riskGroup.get('itemPlanSelectedCode').setValidators(Validators.required);
            riskGroup.get('itemPlanSelectedDesc').setValidators(Validators.required);
            let nomineeList: FormArray = <FormArray>riskGroup.get('nomineeList');
            nomineeList.controls.forEach(element => {
                element = this.setPAQuotNomineeValidators(element);
            });
