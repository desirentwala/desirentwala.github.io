...
export class TravelQuoteValidator {
    ...
    setTravelQuotInsuredValidator(_insuredTravelQuotForm) {
        ...
        if (this.insuredTravelQuotForm.controls['customerInfo'].get('policyHolderType').value === 'O') {
            ...
            this.insuredTravelQuotForm.controls['customerInfo'].get('appMName').setValidators(null);
            this.insuredTravelQuotForm.controls['customerInfo'].get('appMName').reset();
            this.insuredTravelQuotForm.controls['customerInfo'].get('appMName').updateValueAndValidity();
            ...
            this.insuredTravelQuotForm.controls['customerInfo'].get('appFName').setValidators(Validators.compose([Validators.required, MaxSizeValidator.maxSize(30), Validators.pattern('([a-zA-Z\'?]{1,30}\s*)+')]));
            this.insuredTravelQuotForm.controls['customerInfo'].get('appFName').updateValueAndValidity();
            this.insuredTravelQuotForm.controls['customerInfo'].get('appMName').setValidators(Validators.pattern('([a-zA-Z\'?]{1,30}\s*)+'));
            this.insuredTravelQuotForm.controls['customerInfo'].get('appMName').updateValueAndValidity();
            this.insuredTravelQuotForm.controls['customerInfo'].get('appLName').setValidators(Validators.compose([Validators.required, MaxSizeValidator.maxSize(30), Validators.pattern('([a-zA-Z\'?]{1,30}\s*)+')]));
            this.insuredTravelQuotForm.controls['customerInfo'].get('appLName').updateValueAndValidity();
    ...
    setInsuredValidators(travelQuoteForm, insuredFormGroup: FormGroup) {
        insuredFormGroup.get('appFName').setValidators(Validators.compose([Validators.required, MaxSizeValidator.maxSize(30), Validators.pattern('([a-zA-Z\'?]{1,30}\s*)+')]));
        insuredFormGroup.get('appLName').setValidators(Validators.compose([Validators.required, MaxSizeValidator.maxSize(30), Validators.pattern('([a-zA-Z\'?]{1,30}\s*)+')]));
    ...
    setQuoteRiskValidators(riskGroup,multiItemFlag:boolean=false) {
        ...
        riskGroup.get('travellerTypeCode').setValidators(Validators.compose([Validators.required]));
        riskGroup.get('travellerTypeCode').updateValueAndValidity();
    ...
    setNomineeValidators(nomineeFormGroup: any) {
        nomineeFormGroup.get('appFName').setValidators(Validators.compose([MaxSizeValidator.maxSize(30), Validators.required, Validators.pattern('([a-zA-Z\'?]{1,30}\s*)+')]));
        nomineeFormGroup.get('appFName').updateValueAndValidity();
        nomineeFormGroup.get('appLName').setValidators(Validators.compose([MaxSizeValidator.maxSize(30), Validators.required, Validators.pattern('([a-zA-Z\'?]{1,30}\s*)+')]));
